...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			//map = new UnfoldingMap(this, 200, 50, 700, 500, new Google.GoogleMapProvider()); // Can only be used 5 times a day
	...
	*/
	...
	{		
		...
		// Like using MS Word or Excel you set the color, alignment and size before you produce the text or shape
		fill(255);
		rect(25, 50, 150, 250);
